      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch(_app.rootUrl + "users/requests", {
              method: "GET",
              headers: {
                Authorization: localStorage.getItem("id_token")
              }
...
document.getElementById("request-form").addEventListener("submit", requestFunction);
...
function requestFunction(event) {
  ...
  var title = document.getElementById("title").value,
      ...
      result = "";
  setTimeout(function () {
    fetch(_app.rootUrl + "users/requests", {
      method: "POST",
      headers: {
      ...
      if (res.status !== "success") {
        ...
        (0, _helpers.getElement)("res-message", result);
...
setTimeout(function () {
  fetchRequests().then(function (data) {
    if (data === "fail") {
      ...
      (0, _helpers.getElement)("request-wrapper", result);
    } else {
      var _result = "";
      var requests = data.my_requests;
      requests.forEach(function (user) {
        var current_status = user.current_status,
            request_id = user.request_id,
            first_name = user.first_name,
            last_name = user.last_name,
            to_char = user.to_char,
            request_title = user.request_title,
            request_description = user.request_description;
        ...
        (0, _helpers.getElement)("request-wrapper", _result);
      });
    }
