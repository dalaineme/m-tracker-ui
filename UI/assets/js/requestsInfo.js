  ...
  fetchRequests().then(function (data) {
    if (data === "fail") {
      ...
      logs.forEach(function (current_value) {
        var request_status = current_value.request_status,
            date_updated = current_value.date_updated;

        status_logs += "\n              <tr>\n                <td>\n                  <span class=\"status-" + current_value.request_status + "\" id=\"the-status\">" + current_value.request_status + "</span>\n                </td>\n                <td>" + current_value.date_updated + "</td>\n              </tr>\n          ";
      });
      (0, _helpers.getElement)("status-logs-table", status_logs);
    }
